...
class AuthService {
  ...
  Future<Map<String, String>> login(String url, String username, String password) async {
    ...
    try {
      final response = await _dio.post(
        ...
        options: Options(headers: {
          'X-Emby-Authorization': 'MediaBrowser Client="FlutterDownloader", Device="FlutterApp", DeviceId="12345", Version="1.0.0"',
        }),
      );
